...
public class BTree {
    ...
    public static <C, K extends C, V extends C> Object[] build(Collection<K> source, UpdateFunction<K, V> updateF) {
        return build(((org.apache.cassandra.utils.BulkIterator.Adapter) org.zlab.ocov.tracker.Runtime.update(BulkIterator.of(source.iterator()), 19, source, updateF)), source.size(), updateF);
    }
    ...
    public static <C, I extends C, O extends C> Object[] build(BulkIterator<I> source, int size, UpdateFunction<I, O> updateF) {
        ...
        if (size == 0)
            return EMPTY_LEAF;
        if ((org.zlab.ocov.tracker.Runtime.updateBranch(size, MAX_KEYS, "<=", 7)))
    ...
    private static <C, I extends C, O extends C> Object[] buildMaximallyDense(BulkIterator<I> source, int childCount, int size, int height, UpdateFunction<I, O> updateF) {
        ...
        if (height == 2) {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(remaining, MAX_KEYS, ">", 8))) {
    ...
    public static class Builder<V> {
        ...
        public Builder<V> resolve(Resolver resolver) {
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(count, 0, ">", 9))) {
                int c = 0;
                int prev = 0;
                for (int i = 1; i < count; i++) {
        ...
        public Object[] build() {
            if (auto)
                autoEnforce();
            try (BulkIterator<V> iterator = ((org.apache.cassandra.utils.BulkIterator.FromArray) org.zlab.ocov.tracker.Runtime.update(BulkIterator.of(values, 0), 64))) {
    ...
    private static class Updater<Compare, Existing extends Compare, Insert extends Compare> extends AbstractUpdater implements AutoCloseable {
        ...
        Object[] update(Object[] update, Object[] insert, Comparator<? super Compare> comparator, UpdateFunction<Insert, Existing> updateF) {
            ...
            org.zlab.ocov.tracker.Runtime.update(this, 11, update, insert, comparator, updateF);
            this.comparator = comparator;
        ...
        private Insert updateRecursive(Insert ik, Object[] unode, Existing uub, BranchBuilder builder) {
            ...
            while (ik != null) {
                ...
                // process next child
                if ((org.zlab.ocov.tracker.Runtime.updateBranch(c, 0, "<", 10))) {
    ...
    private static abstract class AbstractTransformer<I, O> extends AbstractUpdater implements AutoCloseable {
        ...
        Object[] apply(Object[] update) {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(queuedToFinish.length, height - 1, "<", 11)))
