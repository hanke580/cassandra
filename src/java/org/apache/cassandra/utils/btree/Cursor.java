    ...
    public void reset(Object[] btree, boolean forwards) {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.utils.btree.BTree.class, org.apache.cassandra.utils.btree.BTree.NEGATIVE_INFINITY, "org.apache.cassandra.utils.btree.BTree.NEGATIVE_INFINITY").toJsonString());
        ...
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                isSerializeLoggingActive.set(true);
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.utils.btree.BTree.class, org.apache.cassandra.utils.btree.BTree.POSITIVE_INFINITY, "org.apache.cassandra.utils.btree.BTree.POSITIVE_INFINITY").toJsonString());
                isSerializeLoggingActive.set(false);
            }
        }
    ...
    private int consumeNextLeaf() {
        ...
        if (node == endNode) {
            ...
            if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
                if (!isSerializeLoggingActive.get()) {
                    isSerializeLoggingActive.set(true);
                    serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(this, this.endIndex, "this.endIndex").toJsonString());
                    isSerializeLoggingActive.set(false);
                }
            }
