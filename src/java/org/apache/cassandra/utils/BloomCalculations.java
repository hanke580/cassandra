...
public class BloomCalculations {
     ...
     */
    static final double[][] probs = new double[][] { // dummy row representing 0 buckets per element
    ...
    public static BloomSpecification computeBloomSpec(int maxBucketsPerElement, double maxFalsePosProb) {
        ...
        if (maxFalsePosProb >= probs[minBuckets][minK]) {
            return ((BloomSpecification) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new BloomSpecification(2, optKPerBuckets[2]), 16));
        }
        ...
        return ((BloomSpecification) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new BloomSpecification(K, bucketsPerElement), 17));
    }
