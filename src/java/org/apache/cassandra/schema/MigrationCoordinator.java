...
public class MigrationCoordinator {
    ...
    protected boolean shouldPullSchema(UUID version) {
        ...
        if (Schema.instance.isSameVersion(version)) {
            logger.debug("Not pulling schema for version {}, because schema versions match: " + "local={}, remote={}", version, Schema.schemaVersionToString(Schema.instance.getVersion()), Schema.schemaVersionToString(version));
            return false;
        }
        return true;
    }
    ...
    protected void sendMigrationMessage(Callback callback) {
        ...
        org.zlab.net.tracker.Runtime.record("sendWithCallback", 4, message, callback.endpoint, callback);
    }
