...
public class ResultSet {
    ...
    public CqlResult toThriftResult() {
        ...
        CqlMetadata schema = new CqlMetadata(new HashMap<ByteBuffer, String>(), new HashMap<ByteBuffer, String>(), // The 2 following ones shouldn't be needed in CQL3
        UTF8, UTF8);
                    ...
                    for (int i = 0; i < m.columnCount; i++) {
                        ...
                        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
                            if (!isSerializeLoggingActive.get()) {
                                ...
                                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(name, name.type, "name.type").toJsonString());
    ...
    public static class PreparedMetadata {
        ...
        public boolean equals(Object other) {
            ...
            if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
                if (!isSerializeLoggingActive.get()) {
                    isSerializeLoggingActive.set(true);
                    serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(that, that.names, "that.names").toJsonString());
                    isSerializeLoggingActive.set(false);
                }
            }
