...
public interface CQL3Type {
    ...
    static final org.slf4j.Logger serialize_logger = org.slf4j.LoggerFactory.getLogger("serialize.logger");
    ...
    public static class Custom implements CQL3Type {
        ...
        public final boolean equals(Object o) {
            ...
            if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
                if (!isSerializeLoggingActive.get()) {
                    isSerializeLoggingActive.set(true);
                    serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(that, that.type, "that.type").toJsonString());
                    isSerializeLoggingActive.set(false);
                }
            }
