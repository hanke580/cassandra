...
final class SelectorFactories implements Iterable<Selector.Factory> {
    ...
    public Iterable<Function> getFunctions() {
        ...
        for (Factory factory : factories) if (factory != null)
    ...
    public Iterator<Factory> iterator() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(this, this.factories, "this.factories").toJsonString());
