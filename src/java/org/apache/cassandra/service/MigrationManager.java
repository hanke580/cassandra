...
public class MigrationManager {
    ...
    public static boolean shouldPullSchemaFrom(InetAddress endpoint) {
         ...
         */
        return MessagingService.instance().knowsVersion(endpoint) && MessagingService.instance().getRawVersion(endpoint) == MessagingService.current_version && !Gossiper.instance.isGossipOnlyMember(endpoint);
    }
    ...
    public static void announceNewKeyspace(KSMetaData ksm, long timestamp, boolean announceLocally) throws ConfigurationException {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeCreateKeyspaceMutation(ksm, timestamp), 22, ksm, timestamp, announceLocally)), announceLocally);
    }
    ...
    private static void announceNewColumnFamily(CFMetaData cfm, boolean announceLocally, boolean throwOnDuplicate) throws ConfigurationException {
        cfm.validate();
        org.zlab.ocov.tracker.Runtime.update(cfm, 101);
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeCreateTableMutation(ksm, cfm, FBUtilities.timestampMicros()), 23, cfm, announceLocally, throwOnDuplicate)), announceLocally);
    }
    ...
    public static void announceNewType(UserType newType, boolean announceLocally) {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeCreateTypeMutation(ksm, newType, FBUtilities.timestampMicros()), 24, newType, announceLocally)), announceLocally);
    }
    ...
    public static void announceNewFunction(UDFunction udf, boolean announceLocally) {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeCreateFunctionMutation(ksm, udf, FBUtilities.timestampMicros()), 25, udf, announceLocally)), announceLocally);
    }
    ...
    public static void announceNewAggregate(UDAggregate udf, boolean announceLocally) {
        ...
        KSMetaData ksm = Schema.instance.getKSMetaData(udf.name().keyspace);
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeCreateAggregateMutation(ksm, udf, FBUtilities.timestampMicros()), 26, udf, announceLocally)), announceLocally);
    }
    ...
    public static void announceKeyspaceUpdate(KSMetaData ksm, boolean announceLocally) throws ConfigurationException {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeCreateKeyspaceMutation(ksm, FBUtilities.timestampMicros()), 27, ksm, announceLocally)), announceLocally);
    }
    ...
    public static void announceColumnFamilyUpdate(CFMetaData cfm, boolean announceLocally) throws ConfigurationException {
        cfm.validate();
        org.zlab.ocov.tracker.Runtime.update(cfm, 102);
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeUpdateTableMutation(ksm, oldCfm, cfm, FBUtilities.timestampMicros()), 28, cfm, announceLocally)), announceLocally);
    }
    ...
    public static void announceKeyspaceDrop(String ksName, boolean announceLocally) throws ConfigurationException {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeDropKeyspaceMutation(oldKsm, FBUtilities.timestampMicros()), 29, ksName, announceLocally)), announceLocally);
    }
    ...
    public static void announceColumnFamilyDrop(String ksName, String cfName, boolean announceLocally) throws ConfigurationException {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeDropTableMutation(ksm, oldCfm, FBUtilities.timestampMicros()), 30, ksName, cfName, announceLocally)), announceLocally);
    }
    ...
    public static void announceTypeDrop(UserType droppedType, boolean announceLocally) {
        ...
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.dropTypeFromSchemaMutation(ksm, droppedType, FBUtilities.timestampMicros()), 31, droppedType, announceLocally)), announceLocally);
    }
    ...
    public static void announceFunctionDrop(UDFunction udf, boolean announceLocally) {
        ...
        KSMetaData ksm = Schema.instance.getKSMetaData(udf.name().keyspace);
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeDropFunctionMutation(ksm, udf, FBUtilities.timestampMicros()), 32, udf, announceLocally)), announceLocally);
    }
    ...
    public static void announceAggregateDrop(UDAggregate udf, boolean announceLocally) {
        ...
        KSMetaData ksm = Schema.instance.getKSMetaData(udf.name().keyspace);
        announce(((org.apache.cassandra.db.Mutation) org.zlab.ocov.tracker.Runtime.update(LegacySchemaTables.makeDropAggregateMutation(ksm, udf, FBUtilities.timestampMicros()), 33, udf, announceLocally)), announceLocally);
    }
    ...
    private static Future<?> announce(final Collection<Mutation> schema) {
        ...
        for (InetAddress endpoint : Gossiper.instance.getLiveMembers()) {
            ...
            if (!endpoint.equals(FBUtilities.getBroadcastAddress()) && MessagingService.instance().knowsVersion(endpoint) && MessagingService.instance().getRawVersion(endpoint) == MessagingService.current_version)
