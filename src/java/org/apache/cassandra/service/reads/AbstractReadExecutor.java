...
public abstract class AbstractReadExecutor {
    ...
    private void makeRequests(ReadCommand readCommand, Iterable<Replica> replicas) {
        ...
        for (Replica replica : replicas) {
            ...
            org.zlab.net.tracker.Runtime.record("sendWithCallback", 11, message, endpoint, handler);
        }
    ...
    static class SpeculatingReadExecutor extends AbstractReadExecutor {
        ...
        public void maybeTryAdditionalReplicas() {
            if (shouldSpeculateAndMaybeWait()) {
                ...
                org.zlab.net.tracker.Runtime.record("sendWithCallback", 12, retryCommand.createMessage(false), extraReplica.endpoint(), handler);
            }
        }
