...
public class StorageProxy implements StorageProxyMBean {
    ...
    private static void asyncRemoveFromBatchlog(Collection<InetAddress> endpoints, UUID uuid) {
        ...
        Mutation mutation = ((Mutation) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Mutation(SystemKeyspace.NAME, UUIDType.instance.decompose(uuid)), 95));
    ...
    private static List<Row> readWithPaxos(List<ReadCommand> commands, ConsistencyLevel consistencyLevel, ClientState state) throws InvalidRequestException, UnavailableException, ReadFailureException, ReadTimeoutException {
        ...
        try {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(commands.size(), 1, ">", 20)))
    ...
    private static abstract class DroppableRunnable implements Runnable {
        ...
        public final void run() {
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - constructionTime), DatabaseDescriptor.getTimeout(verb), ">", 21))) {
