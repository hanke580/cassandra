...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean {
    ...
    protected void markAsShutdown(InetAddress endpoint) {
        ...
        for (IEndpointStateChangeSubscriber subscriber : subscribers) subscriber.onChange(endpoint, ApplicationState.STATUS, shutdown);
    ...
    */
    ...
    private CassandraVersion computeMinVersion() {
        ...
        for (InetAddress addr : Iterables.concat(Gossiper.instance.getLiveMembers(), Gossiper.instance.getUnreachableMembers())) {
