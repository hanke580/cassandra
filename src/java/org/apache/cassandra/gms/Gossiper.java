...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean {
    ...
    private static final List<String> ADMINISTRATIVELY_INACTIVE_STATES = Arrays.asList(VersionedValue.HIBERNATE, VersionedValue.REMOVED_TOKEN, VersionedValue.STATUS_LEFT);
    ...
    private void markAlive(final InetAddressAndPort addr, final EndpointState localState) {
        ...
        org.zlab.net.tracker.Runtime.record("sendWithCallback", 3, echoMessage, addr, echoHandler);
