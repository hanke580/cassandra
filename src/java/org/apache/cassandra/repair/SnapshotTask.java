...
public class SnapshotTask extends AbstractFuture<InetAddress> implements RunnableFuture<InetAddress> {
    ...
    public void run() {
        ...
        org.zlab.net.tracker.Runtime.record("sendRR", 21, new SnapshotMessage(desc).createMessage(), endpoint, new SnapshotCallback(this), TimeUnit.HOURS.toMillis(1), true);
    }
