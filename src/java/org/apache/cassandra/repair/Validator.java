...
public class Validator implements Runnable {
    ...
    public void fail() {
        ...
        org.zlab.net.tracker.Runtime.record("sendOneWay", 19, new ValidationComplete(desc).createMessage(), initiator);
    }
    ...
    public void run() {
        ...
        org.zlab.net.tracker.Runtime.record("sendOneWay", 20, new ValidationComplete(desc, trees).createMessage(), initiator);
    }
}
