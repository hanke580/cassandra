...
public class MmappedSegmentedFile extends SegmentedFile {
    ...
    public long[] copyReadableBounds() {
        ...
        for (int i = 0; i < segments.length; i++) bounds[i] = segments[i].left;
    ...
    public static class Builder extends SegmentedFile.Builder {
        ...
        public static class Boundaries {
            ...
            public long[] finish(long length, boolean isFinal) {
                ...
                while (boundaries[fixedCount - 1] >= length) boundaries[fixedCount--] = 0;
            ...
            for (long boundary : boundaries) {
                if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
                    if (!isSerializeLoggingActive.get()) {
                        ...
                        serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(boundaries, boundary, "boundary").toJsonString());
        ...
        public void deserializeBounds(DataInput in) throws IOException {
            ...
            for (int i = 0; i < size; i++) boundaries[i] = in.readLong();
