...
public class SequentialWriter extends OutputStream implements WritableByteChannel, Transactional {
    ...
    public static CompressedSequentialWriter open(String dataFilePath, String offsetsPath, CompressionParameters parameters, MetadataCollector sstableMetadataCollector) {
        return ((CompressedSequentialWriter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new CompressedSequentialWriter(new File(dataFilePath), offsetsPath, parameters, sstableMetadataCollector), 14));
    }
