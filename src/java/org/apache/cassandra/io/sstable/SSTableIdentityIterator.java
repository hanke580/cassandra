...
public class SSTableIdentityIterator extends AbstractIterator<Unfiltered> implements Comparable<SSTableIdentityIterator>, UnfilteredRowIterator {
    ...
    public EncodingStats stats() {
        ...
        return ((EncodingStats) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new EncodingStats(sstable.getMinTimestamp(), sstable.getMinLocalDeletionTime(), sstable.getMinTTL()), 289));
    }
