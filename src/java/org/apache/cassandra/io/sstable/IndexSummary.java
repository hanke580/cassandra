...
public class IndexSummary extends WrappedSharedCloseable {
    ...
    public IndexSummary sharedCopy() {
        return ((IndexSummary) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new IndexSummary(this), 281));
    }
    ...
    public static class IndexSummarySerializer {
        ...
        public IndexSummary deserialize(DataInputStream in, IPartitioner partitioner, boolean haveSamplingLevel, int expectedMinIndexInterval, int maxIndexInterval) throws IOException {
            ...
            return ((IndexSummary) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new IndexSummary(partitioner, offsets, offsetCount, entries, entries.size(), fullSamplingSummarySize, minIndexInterval, samplingLevel), 282));
        }
    }
}
