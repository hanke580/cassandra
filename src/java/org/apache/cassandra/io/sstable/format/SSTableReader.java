...
public abstract class SSTableReader extends SSTable implements SelfRefCounted<SSTableReader> {
    ...
    private void buildSummary(boolean recreateBloomFilter, SegmentedFile.Builder ibuilder, SegmentedFile.Builder dbuilder, boolean summaryLoaded, int samplingLevel) throws IOException {
        ...
        try (RandomAccessReader primaryIndex = RandomAccessReader.open(new File(descriptor.filenameFor(Component.PRIMARY_INDEX)))) {
            ...
            try (IndexSummaryBuilder summaryBuilder = summaryLoaded ? null : ((IndexSummaryBuilder) org.zlab.ocov.tracker.Runtime.update(new IndexSummaryBuilder(estimatedKeys, metadata.params.minIndexInterval, samplingLevel), 205, recreateBloomFilter, ibuilder, dbuilder, summaryLoaded, samplingLevel))) {
                long indexPosition;
