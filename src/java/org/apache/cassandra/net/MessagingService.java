...
public final class MessagingService implements MessagingServiceMBean {
     ...
     */
    public static final EnumSet<Verb> DROPPABLE_VERBS = EnumSet.of(Verb._TRACE, Verb.MUTATION, Verb.COUNTER_MUTATION, Verb.READ_REPAIR, Verb.READ, Verb.RANGE_SLICE, Verb.PAGED_RANGE, Verb.REQUEST_RESPONSE);
    ...
    public void shutdown() {
        ...
        try {
            clearMessageSinks();
            for (SocketThread th : socketThreads) try {
                th.close();
            } catch (IOException e) {
    ...
    private static void handleIOException(IOException e) throws IOException {
        ...
        if ((!"Unknown error: 316".equals(e.getMessage()) || !"Mac OS X".equals(System.getProperty("os.name"))) && // handle shutdown for in-JVM dtests
        !"Thread signal failed".equals(e.getMessage()) && !"Bad file descriptor".equals(e.getMessage()) && !"No such file or directory".equals(e.getMessage()))
            throw e;
    }
