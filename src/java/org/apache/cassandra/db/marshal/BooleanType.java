    ...
    public TypeSerializer<Boolean> getSerializer() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.serializers.BooleanSerializer.class, org.apache.cassandra.serializers.BooleanSerializer.instance, "org.apache.cassandra.serializers.BooleanSerializer.instance").toJsonString());
