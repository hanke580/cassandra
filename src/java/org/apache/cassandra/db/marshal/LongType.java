    ...
    public TypeSerializer<Long> getSerializer() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.serializers.LongSerializer.class, org.apache.cassandra.serializers.LongSerializer.instance, "org.apache.cassandra.serializers.LongSerializer.instance").toJsonString());
