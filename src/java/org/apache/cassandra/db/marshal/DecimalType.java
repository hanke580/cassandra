    ...
    public TypeSerializer<BigDecimal> getSerializer() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.serializers.DecimalSerializer.class, org.apache.cassandra.serializers.DecimalSerializer.instance, "org.apache.cassandra.serializers.DecimalSerializer.instance").toJsonString());
