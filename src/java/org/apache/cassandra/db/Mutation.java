...
public class Mutation implements IMutation {
    ...
    public void apply(boolean durableWrites, boolean isDroppable) {
        ((org.apache.cassandra.db.Keyspace) org.zlab.ocov.tracker.Runtime.update(Keyspace.open(keyspaceName), 179, durableWrites, isDroppable)).apply(this, durableWrites, true, isDroppable);
    }
    ...
    public static class MutationSerializer implements IVersionedSerializer<Mutation> {
        ...
        public Mutation deserialize(DataInputPlus in, int version, SerializationHelper.Flag flag) throws IOException {
            ...
            if (size == 1) {
                return ((Mutation) org.zlab.ocov.tracker.Runtime.update(new Mutation(update), 180, in, version, flag));
            }
