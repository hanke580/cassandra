...
public abstract class Transformation<I extends BaseRowIterator<?>> {
    ...
    static UnfilteredPartitions mutable(UnfilteredPartitionIterator iterator) {
        return iterator instanceof UnfilteredPartitions ? (UnfilteredPartitions) iterator : ((UnfilteredPartitions) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new UnfilteredPartitions(iterator), 224));
    }
    ...
    static UnfilteredRows mutable(UnfilteredRowIterator iterator) {
        return iterator instanceof UnfilteredRows ? (UnfilteredRows) iterator : ((UnfilteredRows) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new UnfilteredRows(iterator), 225));
    }
    ...
    static UnfilteredRows wrapIterator(UnfilteredRowIterator iterator, PartitionColumns columns) {
        return ((UnfilteredRows) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new UnfilteredRows(iterator, columns), 226));
    }
