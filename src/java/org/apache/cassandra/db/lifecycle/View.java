    ...
    public Memtable getCurrentMemtable() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(this, this.liveMemtables, "this.liveMemtables").toJsonString());
    ...
    static Function<View, View> updateCompacting(final Set<SSTableReader> unmark, final Iterable<SSTableReader> mark) {
        ...
        return new Function<View, View>() {
            ...
            public View apply(View view) {
                ...
                return new View(view.liveMemtables, view.flushingMemtables, view.sstablesMap, replace(view.compacting, unmark, mark), view.premature, view.intervalTree);
            }
        };
    }
    ...
    static Predicate<View> permitCompacting(final Iterable<SSTableReader> readers) {
        return new Predicate<View>() {
            ...
            public boolean apply(View view) {
                for (SSTableReader reader : readers) if (view.compacting.contains(reader) || view.sstablesMap.get(reader) != reader || reader.isMarkedCompacted() || view.premature.contains(reader))
                    return false;
                return true;
            }
        };
    ...
    static Function<View, View> updateLiveSet(final Set<SSTableReader> remove, final Iterable<SSTableReader> add) {
        ...
        return new Function<View, View>() {
            ...
            public View apply(View view) {
                ...
                return new View(view.liveMemtables, view.flushingMemtables, sstableMap, view.compacting, view.premature, SSTableIntervalTree.build(sstableMap.keySet()));
            }
        };
    }
    ...
    static Function<View, View> replaceFlushed(final Memtable memtable, final SSTableReader flushed) {
        return new Function<View, View>() {
            ...
            public View apply(View view) {
                ...
                if (flushed == null)
                    return new View(view.liveMemtables, flushingMemtables, view.sstablesMap, view.compacting, view.premature, view.intervalTree);
                ...
                return new View(view.liveMemtables, flushingMemtables, sstableMap, compacting, premature, SSTableIntervalTree.build(sstableMap.keySet()));
            }
        };
    }
