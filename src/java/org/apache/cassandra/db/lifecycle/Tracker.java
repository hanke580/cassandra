...
public class Tracker {
    ...
    Pair<View, View> apply(Predicate<View> permit, Function<View, View> function) {
        while (true) {
            ...
            org.zlab.ocov.tracker.Runtime.update(function, 105, permit, function);
    ...
    public void reset(Memtable memtable) {
        view.set(((View) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new View(memtable != null ? singletonList(memtable) : Collections.emptyList(), Collections.emptyList(), Collections.emptyMap(), Collections.emptyMap(), SSTableIntervalTree.empty()), 227)));
    }
