...
public class Keyspace {
        ...
        if (keyspaceInstance == null) {
            ...
            synchronized (Keyspace.class) {
                ...
                if (keyspaceInstance == null) {
                    ...
                    keyspaceInstance = ((Keyspace) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Keyspace(keyspaceName, loadSSTables), 90));
    ...
    public Row getRow(QueryFilter filter) {
        ...
        return ((Row) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Row(filter.key, columnFamily), 91));
    }
