...
public class EncodingStats {
    ...
    public EncodingStats mergeWith(EncodingStats that) {
        ...
        return ((EncodingStats) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new EncodingStats(minTimestamp, minDelTime, minTTL), 76));
    }
    ...
    public static class Collector implements PartitionStatisticsCollector {
        ...
        public EncodingStats get() {
            return ((EncodingStats) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new EncodingStats(isTimestampSet ? minTimestamp : TIMESTAMP_EPOCH, isDelTimeSet ? minDeletionTime : DELETION_TIME_EPOCH, isTTLSet ? minTTL : TTL_EPOCH), 77));
        }

        public static EncodingStats collect(Row staticRow, Iterator<Row> rows, DeletionInfo deletionInfo) {
            Collector collector = ((Collector) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Collector(), 78));
    ...
    public static class Serializer {
        ...
        public EncodingStats deserialize(DataInputPlus in) throws IOException {
            ...
            return ((EncodingStats) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new EncodingStats(minTimestamp, minLocalDeletionTime, minTTL), 79));
        }
    }
}
