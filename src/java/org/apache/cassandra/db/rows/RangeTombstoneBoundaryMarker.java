...
public class RangeTombstoneBoundaryMarker extends AbstractRangeTombstoneMarker {
    ...
    public RangeTombstoneBoundMarker createCorrespondingCloseMarker(boolean reversed) {
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.update(new RangeTombstoneBoundMarker(closeBound(reversed), closeDeletionTime(reversed)), 51, reversed));
    }

    public RangeTombstoneBoundMarker createCorrespondingOpenMarker(boolean reversed) {
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.update(new RangeTombstoneBoundMarker(openBound(reversed), openDeletionTime(reversed)), 52, reversed));
    }
