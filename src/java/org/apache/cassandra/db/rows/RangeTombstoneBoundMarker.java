...
public class RangeTombstoneBoundMarker extends AbstractRangeTombstoneMarker {
    ...
    public static RangeTombstoneBoundMarker inclusiveOpen(boolean reversed, ByteBuffer[] boundValues, DeletionTime deletion) {
        ...
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(bound, deletion), 81));
    }
    ...
    public static RangeTombstoneBoundMarker exclusiveOpen(boolean reversed, ByteBuffer[] boundValues, DeletionTime deletion) {
        ...
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(bound, deletion), 82));
    }
    ...
    public static RangeTombstoneBoundMarker inclusiveClose(boolean reversed, ByteBuffer[] boundValues, DeletionTime deletion) {
        ...
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(bound, deletion), 83));
    }
    ...
    public static RangeTombstoneBoundMarker exclusiveClose(boolean reversed, ByteBuffer[] boundValues, DeletionTime deletion) {
        ...
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(bound, deletion), 84));
    }
    ...
    public RangeTombstoneBoundMarker copy(AbstractAllocator allocator) {
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.update(new RangeTombstoneBoundMarker(clustering().copy(allocator), deletion), 35, allocator));
    }

    public RangeTombstoneBoundMarker withNewOpeningDeletionTime(boolean reversed, DeletionTime newDeletionTime) {
        if (!isOpen(reversed))
            throw new IllegalStateException();
        return ((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(clustering(), newDeletionTime), 85));
    }
