...
public class BTreeRow extends AbstractRow {
    ...
    public static BTreeRow create(Clustering<?> clustering, LivenessInfo primaryKeyLivenessInfo, Deletion deletion, Object[] btree) {
        ...
        return ((org.apache.cassandra.db.rows.BTreeRow) org.zlab.ocov.tracker.Runtime.update(create(clustering, primaryKeyLivenessInfo, deletion, btree, minDeletionTime), 5, clustering, primaryKeyLivenessInfo, deletion, btree));
    }
    ...
    public long unsharedHeapSize() {
        long heapSize = EMPTY_SIZE + clustering.unsharedHeapSize() + primaryKeyLivenessInfo.unsharedHeapSize() + deletion.unsharedHeapSize() + BTree.sizeOfStructureOnHeap(btree);
