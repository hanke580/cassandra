...
public abstract class DataLimits {
    ...
    public enum Kind {
        ...
        CQL_LIMIT, CQL_PAGING_LIMIT, THRIFT_LIMIT, SUPER_COLUMN_COUNTING_LIMIT
    }
    ...
    public static abstract class Counter extends StoppingTransformation<BaseRowIterator<?>> {
        ...
        protected BaseRowIterator<?> applyToPartition(BaseRowIterator<?> partition) {
            return partition instanceof UnfilteredRowIterator ? Transformation.apply((UnfilteredRowIterator) partition, ((org.apache.cassandra.db.filter.DataLimits.Counter) org.zlab.ocov.tracker.Runtime.update(this, 45, partition))) : Transformation.apply((RowIterator) partition, ((org.apache.cassandra.db.filter.DataLimits.Counter) org.zlab.ocov.tracker.Runtime.update(this, 46, partition)));
        }
