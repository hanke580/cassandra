...
public class SliceQueryFilter implements IDiskAtomFilter {
    ...
    public SliceQueryFilter cloneShallow() {
        return ((SliceQueryFilter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new SliceQueryFilter(slices, reversed, count, compositesToGroup), 82));
    }

    public SliceQueryFilter withUpdatedCount(int newCount) {
        return ((SliceQueryFilter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new SliceQueryFilter(slices, reversed, newCount, compositesToGroup), 83));
    }

    public SliceQueryFilter withUpdatedSlices(ColumnSlice[] newSlices) {
        return ((SliceQueryFilter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new SliceQueryFilter(newSlices, reversed, count, compositesToGroup), 84));
    }
    ...
    public Pair<SliceQueryFilter, SliceQueryFilter> splitOutStaticSlice(CFMetaData cfm) {
        ...
        return Pair.create(((SliceQueryFilter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new SliceQueryFilter(staticSliceEnd, Composites.EMPTY, true, count, compositesToGroup), 85)), ((SliceQueryFilter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new SliceQueryFilter(nonStaticSlices.toArray(new ColumnSlice[nonStaticSlices.size()]), true, count, compositesToGroup), 86)));
    }
    ...
    public ColumnFamily trim(ColumnFamily cf, int trimTo, long now) {
        ...
        if ((org.zlab.ocov.tracker.Runtime.updateBranch(cf.getColumnCount(), trimTo, "<", 18)))
            return cf;
    ...
    public static class Serializer implements IVersionedSerializer<SliceQueryFilter> {
        ...
        public SliceQueryFilter deserialize(DataInput in, int version) throws IOException {
            ...
            return ((SliceQueryFilter) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new SliceQueryFilter(slices, reversed, count, compositesToGroup), 87));
        }
        ...
        public long serializedSize(SliceQueryFilter f, int version) {
            ...
            for (ColumnSlice slice : f.slices) size += type.sliceSerializer().serializedSize(slice, version);
