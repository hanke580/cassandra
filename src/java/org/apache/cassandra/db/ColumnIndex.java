...
public class ColumnIndex {
    ...
    public static ColumnIndex writeAndBuildIndex(UnfilteredRowIterator iterator, SequentialWriter output, SerializationHeader header, Version version) throws IOException {
        ...
        Builder builder = ((Builder) org.zlab.ocov.tracker.Runtime.update(new Builder(iterator, output, header, version.correspondingMessagingVersion()), 111, iterator, output, header, version));
