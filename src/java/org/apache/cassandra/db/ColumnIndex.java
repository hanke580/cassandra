...
public class ColumnIndex {
    ...
    private void addIndexBlock() throws IOException {
        ...
        if (buffer == null) {
            ...
            if ((org.zlab.ocov.tracker.Runtime.updateBranch(indexSamplesSerializedSize + columnIndexCount * TypeSizes.sizeof(0), cacheSizeThreshold, ">", 1))) {
    ...
    private void add(Unfiltered unfiltered) throws IOException {
        ...
        if ((org.zlab.ocov.tracker.Runtime.updateBranch(currentPosition() - startPosition, DatabaseDescriptor.getColumnIndexSize(), ">=", 2)))
            addIndexBlock();
    }
