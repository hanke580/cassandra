...
public class ColumnFamilyStore implements ColumnFamilyStoreMBean {
    ...
    public ViewFragment select(Function<View, Iterable<SSTableReader>> filter) {
        ...
        org.zlab.ocov.tracker.Runtime.update(filter, 107, filter);
        return ((ViewFragment) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new ViewFragment(sstables, view.getAllMemtables()), 230));
    }
