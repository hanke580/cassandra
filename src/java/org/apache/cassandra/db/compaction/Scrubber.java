...
public class Scrubber implements Closeable {
    ...
    public void scrub() {
        ...
        try (SSTableRewriter writer = SSTableRewriter.construct(cfs, transaction, false, sstable.maxDataAge);
            ...
            org.zlab.ocov.tracker.Runtime.update(writer, 77);
    ...
    private UnfilteredRowIterator getIterator(DecoratedKey key) {
        RowMergingSSTableIterator rowMergingIterator = new RowMergingSSTableIterator(((org.apache.cassandra.io.sstable.SSTableIdentityIterator) org.zlab.ocov.tracker.Runtime.update(SSTableIdentityIterator.create(sstable, dataFile, key), 66, key)));
