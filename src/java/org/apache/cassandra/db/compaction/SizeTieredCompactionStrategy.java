...
public class SizeTieredCompactionStrategy extends AbstractCompactionStrategy {
    ...
    public synchronized AbstractCompactionTask getNextBackgroundTask(int gcBefore) {
        while (true) {
            ...
            if (transaction != null) {
                return ((CompactionTask) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new CompactionTask(cfs, transaction, gcBefore), 221));
            }
        }
    }
    ...
    public AbstractCompactionTask getUserDefinedTask(Collection<SSTableReader> sstables, final int gcBefore) {
        ...
        return ((CompactionTask) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new CompactionTask(cfs, transaction, gcBefore), 222)).setUserDefined(true);
    }
