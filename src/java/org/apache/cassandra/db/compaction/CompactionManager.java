...
public class CompactionManager implements CompactionManagerMBean {
    ...
    public void performAnticompaction(ColumnFamilyStore cfs, Collection<Range<Token>> ranges, Refs<SSTableReader> validatedForRepair, LifecycleTransaction txn, long repairedAt) throws InterruptedException, IOException {
        ...
        for (SSTableReader sstable : sstables) wasRepairedBefore.put(sstable, sstable.isRepaired());
    ...
    private synchronized Refs<SSTableReader> getSSTablesToValidate(ColumnFamilyStore cfs, Validator validator) {
        ...
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(validator, validator.desc, "validator.desc").toJsonString());
