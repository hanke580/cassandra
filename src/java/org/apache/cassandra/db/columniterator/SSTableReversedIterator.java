...
public class SSTableReversedIterator extends AbstractSSTableIterator {
    ...
    public SSTableReversedIterator(SSTableReader sstable, DecoratedKey key, ColumnFilter columns, boolean isForThrift, SSTableReadsListener listener) {
    ...
    private class ReverseReader extends Reader {
        ...
        protected void loadFromDisk(Slice.Bound start, Slice.Bound end, boolean includeFirst, boolean hasPreviousBlock, boolean hasNextBlock) throws IOException {
            ...
            if (openMarker != null) {
                ...
                buffer.add(((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(markerStart, openMarker), 180)));
                if (hasNextBlock)
            ...
            if (openMarker != null) {
                ...
                buffer.add(((RangeTombstoneBoundMarker) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new RangeTombstoneBoundMarker(markerEnd, openMarker), 181)));
                if (hasPreviousBlock)
    ...
    private class ReverseIndexedReader extends ReverseReader {
        ...
        private void readCurrentBlock(boolean hasPreviousBlock, boolean hasNextBlock) throws IOException {
            ...
            loadFromDisk(canIncludeSliceStart ? slice.start() : null, canIncludeSliceEnd ? slice.end() : null, includeFirst, hasPreviousBlock, hasNextBlock);
            setIterator(slice);
        }
