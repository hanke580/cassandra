    ...
    private void addDifferentCells(Row existingBaseRow, Row mergedBaseRow) {
        ...
        for (ColumnData mergedData : mergedBaseRow) {
            ...
            while (existingIter.hasNext()) {
                ...
                org.zlab.ocov.tracker.Runtime.update(existingIter, 177, existingBaseRow, mergedBaseRow);
                if (cmp < 0)
                    break;
            ...
            org.zlab.ocov.tracker.Runtime.update(existingIter, 176, existingBaseRow, mergedBaseRow);
