...
final class HintsDispatcher implements AutoCloseable {
    ...
    private Callback sendHint(Hint hint) {
        ...
        org.zlab.net.tracker.Runtime.record("sendWithCallback", 18, message, address, callback);
        return callback;
    }
    ...
    private Callback sendEncodedHint(ByteBuffer hint) {
        ...
        org.zlab.net.tracker.Runtime.record("sendWithCallback", 19, Message.out(HINT_REQ, message), address, callback);
        return callback;
    }
