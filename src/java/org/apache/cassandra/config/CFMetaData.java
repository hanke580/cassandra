...
public final class CFMetaData {
    ...
    public static CFMetaData create(String ksName, String name, UUID cfId, boolean isDense, boolean isCompound, boolean isSuper, boolean isCounter, boolean isView, List<ColumnDefinition> columns, IPartitioner partitioner) {
        ...
        return ((CFMetaData) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new CFMetaData(ksName, name, cfId, isSuper, isCounter, isDense, isCompound, isView, partitions, clusterings, builder.build(), partitioner, null, null), 8));
    }
    ...
    public CFMetaData reloadIndexMetadataProperties(CFMetaData parent) {
        ...
        return ((org.apache.cassandra.config.CFMetaData) org.zlab.ocov.tracker.Runtime.monitorCreationContext(params(indexParams.build()), 0));
    }
    ...
    public CFMetaData copy(UUID newCfId) {
        return ((org.apache.cassandra.config.CFMetaData) org.zlab.ocov.tracker.Runtime.monitorCreationContext(copyOpts(new CFMetaData(ksName, cfName, newCfId, isSuper(), isCounter(), isDense(), isCompound(), isView(), copy(partitionKeyColumns), copy(clusteringColumns), copy(partitionColumns), partitioner, superCfKeyColumn, superCfValueColumn), this), 9));
    }
    ...
    public static class Builder {
        ...
        public static Builder create(String keyspace, String table, boolean isDense, boolean isCompound, boolean isSuper, boolean isCounter) {
            return ((Builder) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Builder(keyspace, table, isDense, isCompound, isSuper, isCounter, false), 10));
        }

        public static Builder createView(String keyspace, String table) {
            return ((Builder) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Builder(keyspace, table, false, true, false, false, true), 11));
        }
        ...
        public CFMetaData build() {
            ...
            return ((CFMetaData) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new CFMetaData(keyspace, table, tableId, isSuper, isCounter, isDense, isCompound, isView, partitions, clusterings, builder.build(), partitioner.orElseGet(DatabaseDescriptor::getPartitioner), null, null), 12));
        }
    }
