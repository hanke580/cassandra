...
public class DatabaseDescriptor {
    ...
    public static String getPartitionerName() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActiveStatic.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.config.DatabaseDescriptor.class, org.apache.cassandra.config.DatabaseDescriptor.paritionerName, "org.apache.cassandra.config.DatabaseDescriptor.paritionerName").toJsonString());
    ...
    public static String getClusterName() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActiveStatic.get()) {
                isSerializeLoggingActiveStatic.set(true);
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.config.DatabaseDescriptor.class, org.apache.cassandra.config.DatabaseDescriptor.conf, "org.apache.cassandra.config.DatabaseDescriptor.conf").toJsonString());
                isSerializeLoggingActiveStatic.set(false);
            }
        }
    ...
    public static InetAddress getListenAddress() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActiveStatic.get()) {
                isSerializeLoggingActiveStatic.set(true);
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.config.DatabaseDescriptor.class, org.apache.cassandra.config.DatabaseDescriptor.listenAddress, "org.apache.cassandra.config.DatabaseDescriptor.listenAddress").toJsonString());
                isSerializeLoggingActiveStatic.set(false);
            }
        }
    ...
    public static InetAddress getBroadcastAddress() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActiveStatic.get()) {
                isSerializeLoggingActiveStatic.set(true);
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.config.DatabaseDescriptor.class, org.apache.cassandra.config.DatabaseDescriptor.broadcastAddress, "org.apache.cassandra.config.DatabaseDescriptor.broadcastAddress").toJsonString());
                isSerializeLoggingActiveStatic.set(false);
            }
        }
    ...
    public static String getLocalDataCenter() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActiveStatic.get()) {
                isSerializeLoggingActiveStatic.set(true);
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(org.apache.cassandra.config.DatabaseDescriptor.class, org.apache.cassandra.config.DatabaseDescriptor.localDC, "org.apache.cassandra.config.DatabaseDescriptor.localDC").toJsonString());
                isSerializeLoggingActiveStatic.set(false);
            }
        }
        return localDC;
