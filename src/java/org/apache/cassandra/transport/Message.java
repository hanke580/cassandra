    ...
    public int getStreamId() {
        if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
            if (!isSerializeLoggingActive.get()) {
                ...
                serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(this, this.streamId, "this.streamId").toJsonString());
            ...
            public void run() {
                ...
                while (null != (flush = queued.poll())) {
                    ...
                    if (org.zlab.dinv.logger.SerializeMonitor.isSerializing) {
                        if (!isSerializeLoggingActive.get()) {
                            isSerializeLoggingActive.set(true);
                            serialize_logger.info(org.zlab.dinv.logger.LogEntry.constructLogEntry(flush, flush.response, "flush.response").toJsonString());
                            isSerializeLoggingActive.set(false);
                        }
                    }
