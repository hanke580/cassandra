...
public class SecondaryIndexManager implements IndexRegistry {
    ...
    public void indexPartition(DecoratedKey key, Set<Index> indexes, int pageSize) {
        ...
        if (!indexes.isEmpty()) {
            ...
            org.zlab.ocov.tracker.Runtime.update(cmd, 9, key, indexes, pageSize);
            int nowInSec = cmd.nowInSec();
            boolean readStatic = false;
            SinglePartitionPager pager = ((SinglePartitionPager) org.zlab.ocov.tracker.Runtime.update(new SinglePartitionPager(cmd, null, Server.CURRENT_VERSION), 10, key, indexes, pageSize));
