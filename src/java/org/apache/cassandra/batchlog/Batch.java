...
public final class Batch {
    ...
    public static Batch createLocal(UUID id, long creationTime, Collection<Mutation> mutations) {
        return ((Batch) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Batch(id, creationTime, mutations, Collections.emptyList()), 299));
    }
    ...
    public static Batch createRemote(UUID id, long creationTime, Collection<ByteBuffer> mutations) {
        return ((Batch) org.zlab.ocov.tracker.Runtime.monitorCreationContext(new Batch(id, creationTime, Collections.<Mutation>emptyList(), mutations), 300));
    }
