...
public class ReadDigestConsistencyTest extends TestBaseImpl
{
    ...
    public static void checkTraceForDigestMismatch(ICoordinator coordinator, String query, Object... boundValues)
    {
        ...
        try
        {
            Object[][] results = coordinator.executeWithTracing(sessionId, query, ConsistencyLevel.ALL, boundValues);
            logger.info("[hklog] results = " + Arrays.deepToString(results) + " for query = " + query);
        }
